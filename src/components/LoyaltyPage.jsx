...
const LoyaltyPage = () => {
    ...
    const handleRedeem = async () => {
        ...
        try {
            const res = await fetch(`process.env.REACT_APP_API_URL || '(process.env.REACT_APP_API_URL || 'http://localhost:8080/api')'/loyalty/${user.userId}/redeem`, {
                method: 'POST',
    ...
    const handleReferral = async () => {
        ...
        try {
            const res = await fetch('process.env.REACT_APP_API_URL || '(process.env.REACT_APP_API_URL || 'http://localhost:8080/api')'/loyalty/referral/apply', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
